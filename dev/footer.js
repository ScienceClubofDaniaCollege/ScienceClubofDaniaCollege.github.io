...
<footer class="page-footer footerbody font-small">
    ...
    <div class="text-center text-md-left mt-5">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
                ...
                <p>
                    <a href="http://mdzahin.tech/">Zahin Afsar</a>
                </p>
            ...
            <div class="col-md-5 col-lg-5 col-xl-5 mx-auto mb-4">
                ...
                <button class="sendbtn disabled bg-primary" type="button" onclick="handleFeedbackForm()" style="transition: .5s;">Send</button>
    ...
    <h6 class=" m-2 badge badge-light">Developed by: 
        <a class="px-1" href="https://nhas.me/">Nurul Huda</a> & <a  class="px-1" href="http://mdzahin.tech/">Zahin Afsar</a>
    </h6>
